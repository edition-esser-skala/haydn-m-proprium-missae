...
CCLIIIOrgano = {
  \relative c {
    ...
    b g e c' f f, r a,
    g g' e c f b, c b
    a a' b c f, \tuplet 3/2 8 { a16^\unisono_\tutti g a f[ e f] cis h \hA cis }
    d8 d f d r e16 d e f g f %20
    e8 e g e r f16 e f d e f
    g8 g, g' f e e, e' d
    cis cis cis h a \hA h16 \hA cis d e f g
    a8 b! a g f d cis a
    ...
    b b' b b b a r g
    f f a, a b d es f %35
    b d, es f b, \tuplet 3/2 8 { b'16^\unisono_\tutti a b d,[ c d] f es f }
    b,4 r b8 d f d
    b f' b es, f f, r16 f f' e
    f4 r f8 a c a
    f f f, f' b, b' r16 b, d b %40
    es8 es, \hA es' e f es d c
    b b b' e, f f, r a\p
    b b b b f f'16.\f f32 \tuplet 3/2 8 { f16[ es d] \hA es d c }
    ...
    es8 es, \hA es'4. c8 d \hA es
    f f, f' fis g g f es
    d d' c b a16 g f es d8 \hA es %50
    f es f f, b4 b'8-\solo a
    g g, d' fis g r g f
    e! g e c f a b g
    c c,16  b a8 b c[ r16 c]^\unisono_\tutti \tuplet 3/2 8 { c'[ b a] b a g }
    f8 f a f r f a f %55
    r d16 c d8 b c b a f
    r c' c c c cis d c
    b b b' a g c, f f,
...
CCLIIIBassFigures = \figuremode {
  ...
  <9>8 <[5]> <6 4> <[5] _!> r2
  r4 \bo <[6]>2.
  r4 \bc q4. <5>16 <6> <6 4>8 <[5] _!>
  r4. <6 4>16 \bo <[5] 3> \bc <[\t] \t>4 <\t>8 <6>
  <_->4. <\t>8 <6> <7>4. %10
  r <6 4>16 \bo <[5] 3> r4 <\t>8 <6>
  <_->4. <\t>8 <6> <7->4.
  r <4! 2>8 <6>2
  ...
  <6->2 <[6!] 5 2>8 <_ 4\+ \t> <6>4
  <4\+ 3>4. <6>8 <6\\> <[6 4]> <5> <6>
  <7 _+>2 <\l \l> \bassFigureExtendersOn
  ...
  r8 <5>4 <6>8 <6 4> <[5] 3> r8. <\t>16 %45
  r2 <7->2 \once \bassFigureExtendersOn
  q4 <7 _-> <9 4->8 <[8] 3>4 <\t>8
  <6>4 <\t>8 <7> <2> <5 _->16 <6 \t> <6>8 q
  ...
  <9>8 <[5]> <6 4> <[5] _!> r2 %60
  r4 <[6]>2.
  <7>8 <6!> <5>4. <6>8 <6 4> <[5] _!>
  r4. <6 4>16 \bo <[5] 3> \bc <[\t] \t>4 <\t>8 <6>
  r4. <\t>8 <6> <7>4.
  r4. <6 4>16 \bo <[5] 3> \bc <[\t] \t>4 <\t>8 <6> %65
  <_->4. <\t>8 <6> <7->4.
  r <4! 2>8 <6>2
  <6 4>4. <[7] 3>8 r2
  <5>4. <6 4>16 \bo <[5] 3> \bc <[\t] \t>4 <\t>8 <6>
  r4. <\t>8 <6> <7>4. %70
  r4. <6 4>16 \bo <[5] 3> \bc <[\t] \t>4 <\t>8 <6>
  <_->4. <\t>8 <6> <7->4.
  r <4! 2>8 <6>2
