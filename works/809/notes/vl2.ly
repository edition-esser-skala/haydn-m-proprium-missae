...
DCCCIXVirgamViolinoII = {
  \relative c' {
    ...
    r8 a'-!\fE fis-! fis-! d'-! d-!
    fis16 d a fis d fis a fis g a g e %70
    a d cis d a d, cis d g a g e
    a d cis d a d, a' g fis a d fis
    e h' g e \appoggiatura d cis8 e16 cis \appoggiatura h a8 h16 g
    fis a h a a4 r8 a
    \appoggiatura a16 g8 fis16 e d4( cis8-.) a' %75
    a16( a') g fis e4( d8-.) dis
    ...
    fis d' a fis d a fis a cis4\trill
    ...
    g fis8 fis a d %95
    d,4 a r
    r8 g' fis16 g a g fis e fis d
    a4.( cis8) e e
    cis( e) d16 a fis'\f a d, fis a d
    e h' g e \appoggiatura d cis8 e16 cis \appoggiatura h a8 e16 g %100
    fis d' a fis d a' fis\p d a d cis e
    d4 d2
    a4 a'16 h cis d cis\f d e cis
    d e fis e d a fis a a,8\p e'
    e16 cis e d d8( fis) d( g) %105
    d( a') d, d d a
    a4 a'16 h cis d cis\f d e cis
    d8 d, d' a a fis
    d fis\p d fis h( d)
    r gis, e \hA gis h( \hA gis) %110
    r a e a e'( a,)
    r h d, h' d( h)
    a( e) a( cis) e( cis)
    a a a a a a
    ...
    a cis e cis cis e a e e cis a cis
    d h d f d h' \hA f d h d, h' d %120
    cis a cis e cis a' e cis a e a cis
    h fis d' h e, cis' cis cis e, h' h h
    a8 e cis( e) a( e)
    \appoggiatura e16 d8 cis16 h a4( gis8-.) e'
    e16( e') d cis h4( a8-.) ais %125
    ...
    r a' e a e'( a,)
    r gis e h' d( h)
    r a cis16 h a gis a \hA gis fis e
    d cis h a gis8 d''( cis) h
    a a'16 e cis'\f h a gis a \hA gis fis e %135
    ...
    d4 c'8( d,) h'( d,)
    c4 c2
    fis8( d) g( d) fis( d) %170
    g4 g2
    h8( d) g,( h) a16 g a fis
    fis4( g8) h, h( g')
    g( e) g( e) g,( e')
    a,( d fis a) g( fis) %175
    fis( e g fis) e d
    ...
    a16( a') g fis e4( d8-.) dis %205
    e16 h g' e h'8 fis,( g) h
    fis4( e-.) e'\p
    d( cis-.) e,
    g( fis-.) d
    fis2 e16( d cis d) %210
    cis8 a'\f e( f) cis( d)
